...
TcpConnectionContext::TcpConnectionContext(int fd, std::unique_ptr<TcpProcessor> receiver,
...
Tcp4Layer::Tcp4Layer(std::string_view host, std::uint16_t port, const TcpOptions& options,
